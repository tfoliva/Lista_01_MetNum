...
print(f"f2(xbar) {f_2p(xbar)}\n \
        ...
        u4f2(xbar) {a_f2p5}\n\n \
      ")
plt.plot(xbar, a_f2p3, "o", color=p_f2p[0].get_color(), label="2nd derivative, 3 points")
plt.plot(xbar, a_f2p5, "*", color=p_f2p[0].get_color(), label="2nd derivative, 5 points")
